            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="widget navy-bg no-padding">
                        ...
                        <div class="flot-chart">
                            <div class="flot-chart-content" id="flot-chart1"
                                 style="padding: 0px; position: relative;"><canvas class="flot-base" width="639"
                                                                                   height="100"
                                                                                   style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 639px; height: 100px;"></canvas><canvas
                                    class="flot-overlay" width="639" height="100"
                                    style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 639px; height: 100px;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3">
                    <div class="widget lazur-bg no-padding">
                        ...
                        <div class="flot-chart">
                            <div class="flot-chart-content" id="flot-chart2"
                                 style="padding: 0px; position: relative;"><canvas class="flot-base" width="304"
                                                                                   height="100"
                                                                                   style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 304px; height: 100px;"></canvas><canvas
                                    class="flot-overlay" width="304" height="100"
                                    style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 304px; height: 100px;"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
